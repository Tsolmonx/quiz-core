...
final class Version20240211114533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE app_question (id INT NOT NULL, question_qroup_id INT NOT NULL, name VARCHAR(255) NOT NULL, position INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_BE7729E3278851E7 ON app_question (question_qroup_id)');
        ...
        $this->addSql('ALTER TABLE app_question ADD CONSTRAINT FK_BE7729E3278851E7 FOREIGN KEY (question_qroup_id) REFERENCES app_question_group (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
